...
public class Interface {
	...
	public static Event createEvent(Event event, String info) {
		...
		//testing GEO, lat and lon floats will need to be optional user input
		event.setGeographicPosition(29.298205f, -157.816414f);
		//testing CLASS, will need to be optional user input
